package aaa.dyne.com.mvp.A.model;

import android.os.Handler;

import aaa.dyne.com.mvp.A.Base.BaseCallback;
import aaa.dyne.com.mvp.A.contract.mvpContract;

/**
 * p>Describe:具体的网络请求操作
 * p>Company:Dyne
 * p>@Author:zsp
 * p>Data:2019/1/10.
 */
public class mvpModelImpl implements mvpContract.Model {
    /**
     * 获取网络接口数据
     *  @param param    请求参数
